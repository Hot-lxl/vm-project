  ...
  <div class="shop-header">
    ...
    >
      <div class="discounts-left">
        <div class="activity">
          <span class="content-tag" :class="supportsClasses[supports[0].type]">
            <span class="mini-tag">{{ supports[0].name }} </span>
          </span>
    ...
    <div class="shop-brief-modal" v-show="ShopShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-guanbi" @click="ShopShow = false"></span>
        </div>
      </div>
    ...
    <div class="activity-sheet" v-show="SupportsShow">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li
            class="activity-item"
            :class="supportsClasses[spts.type]"
            v-for="(spts, index) in supports"
            :key="index"
          >
            <span class="content-tag">
              <span class="mini-tag">{{ spts.name }} </span>
            </span>
            <span class="activity-content">{{ spts.content }} </span>
          </li>
        </ul>
        <div class="activity-sheet-close">
          <span
            class="iconfont icon-guanbi"
            @click="SupportsShow = false"
          ></span>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ShopShow: false, //商铺信息
      SupportsShow: false, //优惠活动
      supportsClasses: ["activity-green", "activity-red", "activity-orange"], //把没个颜色装入一个数组
    };
  },
  computed: {
    //获取商家信息
